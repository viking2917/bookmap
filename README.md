...
Open the example maps to see the results The UI will let you save the map image to a file (in case you want to include in a blog post!), or change the POI data to render your own spots. The format for POI entry is an array of lat/lon/name/description entries:
